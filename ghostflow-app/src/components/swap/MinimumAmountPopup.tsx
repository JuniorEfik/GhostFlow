  ...
  return (
    ...
    >
      ...
      <p className="text-gray-600 dark:text-white/70 text-center text-sm mb-6">
        Swaps and sends require at least <span className="font-semibold text-amber-600 dark:text-amber-400">10 USDC</span>.
        {currentAmount > 0 && (
          <span className="block mt-2">
            Your amount: <span className="text-gray-900 dark:text-white/90">{currentAmount.toLocaleString()} USDC</span>
          </span>
        )}
      </p>
      <button
