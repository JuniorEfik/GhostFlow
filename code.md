...
function AppProvider({ children }) {
  ...
  return (
    <SilentSwapProvider 
      ...
      bitcoinConnector={bitcoinConnector}
      bitcoinConnection={bitcoinConnectionAdapter}
    >
      {children}
    </SilentSwapProvider>
  );
...
function App() {
  ...
  return (
    <SilentSwapProvider 
      ...
      bitcoinConnector={bitcoinConnector}
      bitcoinConnection={bitcoinConnectionAdapter}
      bitcoinRpcUrl={undefined} // Optional: custom Bitcoin RPC URL
...
- **Bitcoin Support**: Integrated support for Bitcoin both as source and destination.
  ...
  const handleExecute = async () => {
    try {
      ...
      const senderContactId = isSourceSolana && solAddress
        ...
        : isSourceBitcoin && bitcoinAddress
        ? `caip10:bip122:*:${bitcoinAddress}`
        : evmAddress
